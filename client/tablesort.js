  ...
  Tablesort.prototype = {
    ...
    init: function (el, options) {
      ...
      var onClick = function () {
        ...
        if (!clickFlag) {
          document.querySelector('.sort-up').classList.remove('sort-up');
          clickFlag = true;
        }
    ...
    sortTable: function (header, update) {
      ...
      var sortFunction = caseInsensitiveSort;
      var item = '';
      var items = [];
      var i = that.thead ? 0 : 1;
      var sortDir;
      var sortMethod = header.getAttribute('data-sort-method');
      var sortOrder = header.getAttribute('data-sort-order');
